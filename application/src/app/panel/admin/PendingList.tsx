...
export default function PendingList() {
  ...
  if (loading) return <p>Chargement des utilisateurs non premium...</p>;
  if (pendingUsers.length === 0) return <p>Aucun utilisateur non premium trouvé.</p>;
      ...
      <tbody>
        {pendingUsers.map((user) => (
          <tr key={user.id} className="bg-white hover:bg-blue-50">
            ...
            <td className="border-b border-gray-200 px-4 py-3 break-words">{user.email}</td>
